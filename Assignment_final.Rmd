---
title: "STA380_Intro_to_ML_Exercises_2"
author: "Shreya Bhootda, Kaushik Kumaran, Ayush Malani, Tanupriya Mehra"
date: "8/14/2021"
output: pdf_document
---
...
Setting up data
```{r cars, echo=FALSE}
green_data <- read.csv('~/Documents/Kaushik Kumaran/Documents/UT Docs/Intro to Machine Learning/STA380-master/data/greenbuildings.csv')
library(corrplot)
library(LICORS)
...
ABIA.data <- read.csv("~/Documents/Kaushik Kumaran/Documents/UT Docs/Intro to Machine Learning/STA380-master/data/ABIA.csv")
...
social_marketing <- read.csv("~/Documents/Kaushik Kumaran/Documents/UT Docs/Intro to Machine Learning/STA380-master/data/social_marketing.csv", row.names = 1)
```
...
4. Used the tm_map function to convert to lower case, remove numbers, remove punctuations, remove excess spaces and remove stopwords.
...
#Reading all folders
train=Sys.glob('~/Documents/Kaushik Kumaran/Documents/UT Docs/Intro to Machine Learning/STA380-master/data/ReutersC50/C50train/*')
```
...
test=Sys.glob('~/Documents/Kaushik Kumaran/Documents/UT Docs/Intro to Machine Learning/STA380-master/data/ReutersC50/C50test/*')
```
...
We first used the Naive Bayes algorithm to identify the authors. This algorithm is based on Bayes' Theorem and assumes independence of the predictor variables involved. This model performs poorly on our training and testing data, identifying just _ authors (an accuracy of _).
...
We also used the K-Nearest Neighbors algorithm with k=1 to reduce computation time and expect better results. However with just _ authors correctly identified, the model gave a sub par accuracy of _.
